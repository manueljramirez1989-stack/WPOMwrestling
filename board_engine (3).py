...
AFFECTED  = {'IL'} if ILONLY else (DEMOTED | EVT_BUMP)
...
print("\n"+"="*72)
print(f"BOARD ENGINE — {'FULL REBUILD' if FULL else 'IL-ONLY' if ILONLY else 'SCOPED RECOMPUTE'} — {'APPLYING' if APPLY else 'PREVIEW (no writes)'}")
print("="*72)
